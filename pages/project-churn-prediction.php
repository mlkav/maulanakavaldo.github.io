      ...
      <div class="container">
        ...
        <div class="col-lg-12">
          <div class="portfolio-info">
            ...
            <ul>
              <li><strong>Category</strong> : Machine Learning, Bussines</li>
              <li><strong>Project date</strong> : 01 October, 2022</li>
              <li>
                <strong>Project URL</strong> :
                <a href="https://github.com/maulanakavaldo/Data-Science">Github</a>
              </li>
            </ul>
            <br />
            <h3>Details</h3>
            <p>
              Get insight from telecom dataset and prediction using 3 machine
              learning algorithm to predic customers churn or not churn.
            </p>
          </div>
        </div>
      </div>
